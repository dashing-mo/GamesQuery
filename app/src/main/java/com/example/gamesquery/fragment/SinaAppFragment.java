 ...
 * Steam价格界面Fragment
 */
public class SinaAppFragment extends Fragment {
    ...
    public String hidehtml =
            "javascript:function setHidehtml(){" +
                    ...
                    "document.getElementsByClassName('input-large search-query')[0].style.display='none';" +
                    "}" +
                    "setHidehtml();";
    ...
    public View onCreateView(@NonNull final LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        String URI = "http://steamdb.sinaapp.com/search/" + value;
