 ...
 * 游侠网搜索界面Fragment
 */
public class YouxiaFindFragment extends Fragment {
    ...
    public String hidehtml =
            "javascript:function setHidehtml(){" +
                    "document.getElementsByClassName('uaHolder')[0].style.display='none';" +
                    "document.getElementsByClassName('search_word')[0].style.display='none';" +
                    "document.getElementsByClassName('commonfooter')[0].style.display='none';" +
                    "}" +
                    "setHidehtml();";
    ...
    public View onCreateView(@NonNull final LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        String URI = "https://3g.ali213.net/search.html?keyword=" + value;
        ...
        FragmentUtils.setScrollBar(wv_news);
