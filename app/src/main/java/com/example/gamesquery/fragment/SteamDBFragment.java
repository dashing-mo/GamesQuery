 ...
 * SteamDB价格界面Fragment
 */
public class SteamDBFragment extends Fragment {
    ...
    public String hidehtml =
            "javascript:function setHidehtml(){" +
                    "document.getElementById('js-header-form').style.display='none';" +
                    "document.getElementsByClassName('header-wrapper owned')[0].style.display='none';" +
                    "document.getElementsByClassName('wrapper-info')[0].style.display='none';" +
                    "document.getElementsByClassName('row dataTable_display')[0].style.display='none';" +
                    "}" +
                    "setHidehtml();";
    ...
    public View onCreateView(@NonNull final LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        value=FragmentUtils.setHtmlTranscoding(preferences, getActivity(), value,"price");
        String URI = "https://steamdb.info/search/?a=app&q=" + value;
