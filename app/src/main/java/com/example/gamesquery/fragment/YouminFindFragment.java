 ...
 * 游民星空搜索界面Fragment
 */
public class YouminFindFragment extends Fragment {
    ...
    public String hidehtml =
            "javascript:function setHidehtml(){" +
                    "document.getElementsByClassName('ymw-search-res-nav ymw-search-res-nav2018')[0].style.display='none';" +
                    "document.getElementsByClassName('ymw-header2018')[0].style.display='none';" +
    ...
    public View onCreateView(@NonNull final LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        String URI = "https://wap.gamersky.com/all/search.html?keyword=" + value;
